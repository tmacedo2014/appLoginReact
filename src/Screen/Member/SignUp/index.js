...
import { Container, Header, Content, Button, Icon, Text, Tab, Tabs, Segment, 
        CardItem, Card, Title, Left, Right, Body, Input, Item, Footer,
         View, FooterTab, Badge, Thumbnail } from 'native-base'
            ...
            <ImageBackground source={require('@Asset/images/bg_main.png')} imageStyle={'cover'} style={Styles.bgCover}>
                ...
                <Content style={Style.layoutInner} contentContainerStyle={Style.layoutContent}>
                    <Tabs tabBarUnderlineStyle={Styles.tabBorder}>
                        <Tab tabStyle={Styles.tabGrey} textStyle={Styles.tabTextActive} activeTabStyle={Styles.tabGrey} activeTextStyle={Styles.tabTextActive} heading="Pessoa Física">
                        ...
                        <Tab tabStyle={Styles.tabGrey} textStyle={Styles.tabTextActive} activeTabStyle={Styles.tabGrey} activeTextStyle={Styles.tabTextActive} heading="Pessoa Jurídica">
